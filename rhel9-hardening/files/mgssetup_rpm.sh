...
# Semicolon delimited list of beacons to use for initial bootstrap download of policies and schedules.
DeployServerURL='http://flexerabcnna1.goodyear.com/ManageSoftDL; http://flexerabcnna2.goodyear.com/ManageSoftDL; http://flexerabcnec1.goodyear.com/ManageSoftDL; http://flexerabcnec2.goodyear.com/ManageSoftDL; http://FA0213.global.ctb/ManageSoftDL'

#INSTALLMACHINEPOLICY=Yes
